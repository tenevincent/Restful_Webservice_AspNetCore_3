    ...
    public class AuthorsController : ControllerBase
    {
        ...
        private IEnumerable<LinkDto> CreateLinksForAuthor(Guid authorId, string fields)
        {
            ...
            if (string.IsNullOrWhiteSpace(fields))
            {
                // GetAuthor
                links.Add(
                  new LinkDto(Url.Link(nameof(AuthorsController.GetAuthor), new { authorId }),
                  "self",
                  "GET"));
            }
            else
            {
                ...
                // GetAuthor
                links.Add(
                  new LinkDto(Url.Link(nameof(AuthorsController.GetAuthor), new { authorId, fields }),
                  "self",
                  "GET"));
            }
            ...
            // DeleteAuthor
            links.Add(
               new LinkDto(Url.Link(nameof(AuthorsController.DeleteAuthor), new { authorId }),
               "delete_author",
               "DELETE"));

            // CreateCourseForAuthor"
            links.Add(
            ...
            // "GetCoursesForAuthor"
            links.Add(
               new LinkDto(Url.Link(nameof(CoursesController.GetCoursesForAuthor) , new { authorId }),
               "courses",
               "GET"));
